    ...
    <footer className="bg-primary text-primary-foreground py-16">
      <div className="container mx-auto px-6">
          ...
          <div>
            ...
            <div className="space-y-3 text-primary-foreground/80">
              <div className="flex items-center gap-3">
                ...
                <a href="mailto:achen@institute.edu" className="hover:text-primary-foreground transition-colors">
                  achen@institute.edu
                </a>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p>Institute for Advanced Computational Sciences</p>
                  <p>Building 32, Room 456</p>
        ...
        <div className="mt-12 pt-8 border-t border-primary-foreground/10 text-center text-sm text-primary-foreground/60">
          <p>© {new Date().getFullYear()} Dr. Alexandra Chen. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
